<?php
/**
 * Handles shortcode creation and replacement. If you modify the code will not work the plugin.
 */
class wpgpo_Codec {

	var $shortcodes = array(
		'plusone' => 'wpgpo_plusone',
	);

	var $data;
	function wpgpo_Codec () { $this->__construct(); }
	...
	function process_plusone_code ($args) {
		...
		$ret = "<div class='wpgpo wpgpo_{$size}_{$count_class}'><g:plusone size='{$size}' count='{$count}' href='{$url}'></g:plusone></div>";
		return $ret;
	}
